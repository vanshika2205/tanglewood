...
const VideoSchema = new mongoose.Schema({
  ...
  ai: {
    ...
    reasons: [String], summary: String, suggestion: String, checkedAt: Date,
...
VideoSchema.index({ title: "text", description: "text", tags: "text", uploaderName: "text" }, { weights: { title: 10, uploaderName: 5, tags: 3, description: 1 }});
